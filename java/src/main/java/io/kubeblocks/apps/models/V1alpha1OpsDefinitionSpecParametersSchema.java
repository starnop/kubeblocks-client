...
public class V1alpha1OpsDefinitionSpecParametersSchema {
  ...
  public V1alpha1OpsDefinitionSpecParametersSchema openAPIV3Schema(Object openAPIV3Schema) {
   ...
   /**
   * openAPIV3Schema is the OpenAPI v3 schema to use for parameter schema. supported properties types: - string - number - integer - array: only supported the item with string type.
