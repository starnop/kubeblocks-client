...
public class V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts {
  ...
  public V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts mountPath(String mountPath) {
  ...
  **/
  ...
  public V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts mountPropagation(String mountPropagation) {
  ...
  **/
  ...
  public V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts name(String name) {
  ...
  **/
  ...
  public V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts readOnly(Boolean readOnly) {
  ...
  **/
  ...
  public V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts subPath(String subPath) {
  ...
  **/
  ...
  public V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts subPathExpr(String subPathExpr) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts v1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts = (V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts) o;
    return Objects.equals(this.mountPath, v1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts.mountPath) &&
        Objects.equals(this.mountPropagation, v1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts.mountPropagation) &&
        Objects.equals(this.name, v1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts.name) &&
        Objects.equals(this.readOnly, v1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts.readOnly) &&
        Objects.equals(this.subPath, v1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts.subPath) &&
        Objects.equals(this.subPathExpr, v1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts.subPathExpr);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1BackupPolicyTemplateSpecTargetVolumesVolumeMounts {\n");
