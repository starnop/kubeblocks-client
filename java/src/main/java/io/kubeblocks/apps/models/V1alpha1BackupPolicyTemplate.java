 ...
 */
@ApiModel(description = "BackupPolicyTemplate is the Schema for the BackupPolicyTemplates API (defined by provider)")
...
public class V1alpha1BackupPolicyTemplate implements io.kubernetes.client.common.KubernetesObject {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "BackupPolicyTemplateStatus defines the observed state of BackupPolicyTemplate")
